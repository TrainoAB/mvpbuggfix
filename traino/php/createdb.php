...
$host = 'localhost';
$username = 's98399_traino_live';
$password = 'Vy53HGqAAqfhFFuCmUmX';
$dbname = 's98399_traino_live';

try {
    // Creating a new PDO instance with utf8mb4 charset
...
try {
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS bugreports (
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS pass_booked (
        ...
        payment_intenet_id VARCHAR(255) NULL,
        INDEX idx_userid (user_id),
     ...
     $pdo->exec("CREATE TABLE IF NOT EXISTS pass_set (
        ...
        singledayrepeat VARCHAR(30) NULL,
