// app/api/bankid/cancel/route.js
...
export async function POST(request) {
  try {
    ...
    return NextResponse.json({ message: 'Authentication cancelled' });
  } catch (error) {
    console.error('Error during BankID cancellation:', error.response?.data || error.message);
